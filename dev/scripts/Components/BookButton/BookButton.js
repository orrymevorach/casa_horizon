...
class BookButton extends React.Component {
    componentDidMount() {
        ...
        const travelerInfoHeight = document.getElementsByClassName('traveler-info')[0].clientHeight
        const aboutHeight = document.getElementsByClassName('about')[0].clientHeight
        const promoHeight = document.getElementsByClassName("promo-video")[0].clientHeight
        const reviewsHeight = document.getElementsByClassName('reviews')[0].clientHeight
        const activitiesHeight = document.getElementsByClassName('activities')[0].clientHeight
        const surfHeight = document.getElementsByClassName('surf')[0].clientHeight
        const totalHeightWithoutFooter = headerHeight + travelerInfoHeight + aboutHeight + promoHeight + reviewsHeight + activitiesHeight + surfHeight
