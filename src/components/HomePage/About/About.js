...
class About extends React.Component {
  componentDidMount() {
    ...
    const animationStartRowOne =
        headerHeight + travellerInfoHeight + boxOne.clientHeight / 4,
      animationStartRowTwo =
        headerHeight +
        travellerInfoHeight +
        rowOneHeight +
        boxThree.clientHeight / 4;
        ...
        <div className="row about-row-two">
          <div className="box box3 box-text">
            ...
            <p className="lh-30">
              ...
              beach bungalows, yet only 25 minutes away from San Juan Del Sur
              town.
            </p>
            <a
              className="button"
